    ...
    <>
      <button
        ...
        className={`fixed bottom-6 right-6 w-14 h-14 bg-yellow-400 rounded-full shadow-lg hover:shadow-xl transition-all hover:scale-110 flex items-center justify-center text-2xl z-30 ${
          isLevelingUp ? 'level-up-glow animate-level-up' : isAnimating ? 'animate-jump-up-twice' : ''
        }`}
      >
      ...
      {showLevelUpToast && (
        <div 
          className="fixed bottom-24 right-6 bg-gradient-to-r from-yellow-400 to-orange-400 text-white px-6 py-3 rounded-lg shadow-xl z-40 animate-slide-in-up animate-fade-out-delayed"
        >

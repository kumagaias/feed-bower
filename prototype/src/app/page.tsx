...
export default function Home() {
  ...
  // Redirect to feeds if user is logged in
  useEffect(() => {
    if (user) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ background: 'linear-gradient(to bottom right, #F5F5DC 0%, #FFFFFF 50%, #CCCC99 100%)' }}>
        <div className="text-center">
          <div className="text-6xl mb-4 nest-animation">🪺</div>
          <p className="text-lg text-gray-600">
            {language === 'ja' ? 'フィードページに移動中...' : 'Redirecting to feeds...'}
          </p>
        </div>
      </div>
    )
    ...
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden pt-16">
        ...
        <div className="relative" style={{
          ...
          <div className="absolute top-32 right-32 px-4 py-3 rounded-2xl text-white font-medium shadow-lg" style={{ backgroundColor: 'var(--color-accent)' }}>
            IoT
          </div>
          ...
          <div className="absolute top-48 right-1/3 px-4 py-3 rounded-2xl text-white font-medium shadow-lg" style={{ backgroundColor: 'var(--color-accent)' }}>
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div className="keyword-float absolute top-32 left-10 text-2xl opacity-30" style={{ animationDelay: '0s' }}>📰</div>
          <div className="keyword-float absolute top-52 right-20 text-2xl opacity-30" style={{ animationDelay: '1s' }}>🔍</div>
          <div className="keyword-float absolute bottom-40 left-20 text-2xl opacity-30" style={{ animationDelay: '2s' }}>🤖</div>
          <div className="keyword-float absolute bottom-20 right-10 text-2xl opacity-30" style={{ animationDelay: '0.5s' }}>❤️</div>
          <div className="keyword-float absolute top-72 left-1/2 text-2xl opacity-30" style={{ animationDelay: '1.5s' }}>🐣</div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg max-w-2xl mx-auto" style={{ color: 'var(--color-accent)' }}>
              {language === 'ja' 

...
- [x] タスク 3.9: サインアップ機能の実装
  ...
  - [x] 3.9.6 パスワード要件の実装
    ...
    - 最小 8 文字、小文字1つ以上、大文字1つ以上、数字1つ以上、特殊文字1つ以上の要件を設定
    - Cognito デフォルトパスワードポリシーに準拠（8文字以上、大文字・小文字・数字・特殊文字すべて必須）
...
- [ ] タスク 3.10: Cognito パスワードポリシー設定
  ...
  - [ ] 3.10.1 Cognito User Pool のパスワードポリシー確認
    ...
    - 現在の設定: 最小8文字、大文字・小文字・数字・特殊文字すべて必須
    - 現在の実装: 最小8文字、小文字1つ以上、大文字1つ以上、数字1つ以上、特殊文字1つ以上
    - _要件: 1.2, 4.2_
